...
User Function KHRPED03()


Local oReport
Private cPerg := "KHRPE03"
Private cNomeProg 	:= "KHRPED03"
...
BEGINSQL ALIAS _cAlias
		%NoParser%
		SELECT DISTINCT FILFULL Filial,
		...
		JOIN SF2010 (NOLOCK) SF2 ON SC5.C5_NOTA=SF2.F2_DOC AND SC5.C5_SERIE=SF2.F2_SERIE
		WHERE SC5.C5_EMISSAO BETWEEN %Exp:MV_PAR01% AND %Exp:MV_PAR02% AND SC5.D_E_L_E_T_='' AND SA1.D_E_L_E_T_='' AND SC5.C5_CLIENTE <> '000001' 
