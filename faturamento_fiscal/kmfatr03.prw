...
/*/{Protheus.doc} KMFATR03
Relatório - Relatorio de pedido           
@author zReport
@since 31/01/2019
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"KMFATR03",;		//Nome do Relatório
								"Relatorio de pedido",;		//Título
...
Static Function fRepPrint(oReport)
	...
	cQryAux += "FROM SC6010 SC6010 (NOLOCK)"		+ STR_PULA
	...
	cQryAux += "AND C5_EMISSAO BETWEEN '" 	+DtoS(mv_par03)+ "' AND '" +DtoS(mv_par04)+ "'"		+ STR_PULA
	cQryAux += "AND C5_MSFIL BETWEEN  '"+mv_par01+"' AND  '"+mv_par02+"'		"+ STR_PULA
