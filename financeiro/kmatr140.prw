...
/*/
USER FUNCTION KMATR140( cAlias, nReg )
...
While !oReport:Cancel() .And. !(cAliasSC1)->(Eof()) .And. (cAliasSC1)->C1_FILIAL == xFilial("SC1") .And. ;
	...
	//³ INCLUIR A DESCRICAO DO CENTRO DE CUSTO - LUIZ EDUARDO .F.C - 27.04.2017 ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oReport:SetTitle(STR0002+"     "+STR0043+" "+Substr((cAliasSC1)->C1_NUM,1,6)+" "+STR0018+" "+(cAliasSC1)->C1_CC+ALLTRIM(POSICIONE("CTT",1,XFILIAL("CTT")+(cAliasSC1)->C1_CC,"CTT_DESC01"))+Space(10)+cEmissao )   
