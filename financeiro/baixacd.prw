...
Description //Esta rotina efetua a baixa dos titulos de CD na data anterior ao vencimento real.
@param xParam Parameter Description
@return xRet Return Description
@author  - Everton Santos
@since 05/03/2020 /*/
//----------------------------------------------------------------------------------------------------
User Function BaixaCd()
...
cQuery += " WHERE E1_TIPO = 'CD' " + CRLF 
cQuery += " AND E1_VENCREA BETWEEN '20180903' AND GETDATE()-1 " + CRLF
...
If Len(aDados) > 0
	...
	For nx := 1 to Len(aDados)
		...
		AADD(aBaixa , {"AUTHIST"     	,"Baixa Automatica - JOBBXCD.",Nil})
