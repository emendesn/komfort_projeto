...
Description // Exclus�o de pedidos lan�ados pelo Tele-Vendas
...
If !AMIIn(13,73) // 13 = SIGATMK, 73 = SIGACRM
	msgAlert('Essa rotina so pode ser utilizada nos modulos SIGATMK e SIGACRM.','ATEN��O')
	Return(.F.)
Endif
...
//Tratamento PARA EXCLUS�O do Or�amento via Afterlogin
If !Empty(xPedido)
	If cPedido <> xPedido
		cPedido:=xPedido
		DbSelectArea("SUA")
...
Description // Efetua a atualiza��o das tabela SC5, SC6, SL4 e SUA.
@param xParam Parameter Description
@return xRet Return Description
@author  - Alexis Duarte
@since ??/11/2018 /*/
...
{"BR_AZUL" 		,"Atendimento com Or�amento " },;      	// "Atendimento com Or?mento "
