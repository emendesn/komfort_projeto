...
±±ºPrograma  ³ KMSACA18 º Autor ³ WELLINGTON RAUL P  º Data ³  29/11/2018 º±±
...
USER FUNCTION KMSACA18()

Private cString   := "SX5"
Private cCadastro := "Cadastro de Erros"
Private aRotina   := { 	{"Pesquisar" ,"AxPesqui",0,1},;
{"Visualizar","AxVisual",0,2},;
{"Incluir"   ,"U_KHMMANO(1)",0,3},;
{"Alterar"   ,"U_KHMMANO(2)",0,4},;
{"Excluir"   ,"AxDeleta",0,5}}

DbSelectArea(cString)
DbSetOrder(1)
DbSetFilter({|| X5_TABELA = 'Z3'},"X5_TABELA = 'Z3'")
...
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ INCLUI/ALTERA REGISTROS NA TABELA SX5 Z3 - ERROS           º±±
±±ÈÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
USER FUNCTION KHMMANO(nOpc)

Local cDesc    := SPACE(55)
Local cCabec   := "Cadastro de Erros - "
Local aButtons := {}
Local lGrava   := .F.
Local cChave   := ""
...
@ 040,010 Say "ERRO : " Size 040,010 Font oFnt Pixel Of oDlg
@ 038,050 MSGET oDesc VAR cDesc OF oDlg PIXEL NOBORDER  SIZE 240,010 FONT oFnt 

ACTIVATE MSDIALOG oDlg ON INIT EnchoiceBar( oDlg, { || IF(!EMPTY(cDesc),(lGrava := .T. , oDlg:End()),MsgAlert("Por Favor Digite o ERRO!!!")) } , { || oDlg:End() },, aButtons)
