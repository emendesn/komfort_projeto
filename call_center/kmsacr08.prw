...
Aadd(aPergunta,{PadR("KMSACR08",10),"01","Responsแvel de  ?" 	,"MV_CH1" ,"C",006,00,"G","MV_PAR01",""     ,""      ,""			,"","","USR",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"02","Responsแvel ate  ?" 	,"MV_CH2" ,"C",006,00,"G","MV_PAR02",""     ,""      ,""			,"","","USR",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"03","Operador de  ?" 		,"MV_CH3" ,"C",006,00,"G","MV_PAR03",""     ,""      ,""			,"","","SU7",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"04","Operador at้ ?" 		,"MV_CH4" ,"C",006,00,"G","MV_PAR04",""     ,""      ,""			,"","","SU7",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"05","Data Abertura de ?"	,"MV_CH5" ,"D",008,00,"G","MV_PAR05",""     ,""      ,""			,"","",""	,""   			})
Aadd(aPergunta,{PadR("KMSACR08",10),"06","Data Abertura at้ ?"	,"MV_CH6" ,"D",008,00,"G","MV_PAR06",""     ,""      ,""			,"","",""	,""   			})
...
Aadd(aPergunta,{PadR("KMSACR08",10),"12","Filial at้  ?" 		,"MV_CHC" ,"C",004,00,"G","MV_PAR12",""     ,""      ,""			,"","","SM0",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"13","Ocorr๊ncia  ?" 		,"MV_CHD" ,"C",050,00,"G","MV_PAR13",""     ,""      ,""			,"","",""	,"U_KMHOCOR()"	})
Aadd(aPergunta,{PadR("KMSACR08",10),"14","A็ใo  ?" 		    	,"MV_CHE" ,"C",050,00,"G","MV_PAR14",""     ,""      ,""			,"","",""	,"U_KMHACAO()"	})
Aadd(aPergunta,{PadR("KMSACR08",10),"15","Comunica็ใo de  ?" 	,"MV_CHF" ,"C",006,00,"G","MV_PAR15",""     ,""      ,""			,"","","SUL",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"16","Comunica็ใo at้  ?"	,"MV_CHG" ,"C",006,00,"G","MV_PAR16",""     ,""      ,""			,"","","SUL",""				})
Aadd(aPergunta,{PadR("KMSACR08",10),"17","Chamados Cancelados"  ,"MV_CHH" ,"C",001,00,"C","MV_PAR17","Nใo","Sim","Ambos"			,"","",""	,""   			})
Aadd(aPergunta,{PadR("KMSACR08",10),"18","Dt.A็ใo De ?"			,"MV_CHI" ,"D",008,00,"G","MV_PAR18",""     ,""      ,""			,"","",""	,""   			}) //#RVC20180410.n
Aadd(aPergunta,{PadR("KMSACR08",10),"19","Dt.A็ใo At้ ?"		,"MV_CHJ" ,"D",008,00,"G","MV_PAR19",""     ,""      ,""			,"","",""	,""   			}) //#RVC20180410.n
...
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Ocorr๊ncia",1)  
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Cod.Responsแvel",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Responsแvel",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Dt.A็ใo",1) 
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Status Chamado",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Status A็ใo",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Comunica็ใo",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Produto",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Desc.Produto",1)
oFWMsExcel:AddColumn("AUD","Analise de Entregas","A็ใo",1)
...
oFWMsExcel:AddColumn("AUD","Analise de Entregas","Observa็ใo",1)
