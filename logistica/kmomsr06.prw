...
±±ºPrograma  ³KMOMSR06  ºAutor  ³Murilo Zoratti        º Data ³  05/11/18 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³  Relatorio de Posição Vazia                              º±±
±±º          ³                                                            º±±
...
oReport:= TReport():New("KMOMSR06","Posição Vazia",_cPerg,{|oReport|PrintReport(oReport)},"Posição Vazia")
oReport:SetTotalInLine(.f.)
oReport:lParamPage := .f.

oSection := TRSection():New(oReport,"Posição Vazia",{"SBE","SBF"})        
...
Aadd(aRegs,{_cPerg,"02","Rua Até..","MV_CH2"   ,"C",15,0,"G","MV_PAR02","SBE","","","","",""})
