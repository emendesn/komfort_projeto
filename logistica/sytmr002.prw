...
±±ºPrograma  ³SYTMR002  ºAutor  ³ Eduardo Patriani   º Data ³  21/11/16   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Gera relatorio do Orcamento de venda utilizando o modelo   º±±
...
//Se endereço de entrega estiver em branco, substitui pelo endereço do cliente
if ALLTRIM(cENDENT) == ""
	cENDENT		:= cENDERECO
	cBAIRENT	:= cBAIRRO 
	cCEPENT		:= cCEP 
