...
User Function zCadSX6(aParams, lCombo, lDelet, lInclui)
    ...
    If !(__cUserid $ '000033')	// Usuario vauires
		Aviso("Acesso não permitido."  , "Usuário sem permissão de acesso.")		
		Return		
	EndIf

    If Empty(aParams)
        aParams := { "KH_ENDERI", "KH_ENDERF" }
    EndIF
