...
ฑฑบPrograma  ณ EnvMail  บAutor  ณ Vanito Rocha   บ Data ณ  08/02/16   บฑฑ
...
User Function MailCobK(_cEmailTo,_cEmailBcc,_cAssunto,_aMsg,_aAttach,_lMostraMsg)
...
_cMsg := "<html>"
_cMsg += "<div><span class=610203920-12022004><FONT face=Verdana color=#000000 size=2>"
_cMsg += "<strong>Central de Relacionamento KomfortHouse</strong></font></span></div><hr>"
For _ni := 1 To Len(_aMsg)
	_cMsg   	+= "<div><font face='Verdana' color='#000000' size='2'><span class=216593018-10022004>"+_aMsg[_ni]+"</span></div><p>"
	_cArqLog 	:= _aMsg[_ni] + Chr(13) + Chr(10)
Next _ni
_cMsg += "Caso necessแrio solicite a 2ฐ via atrav้s do e-mail cobranca@komforthouse.com.br" 
_cMsg += "<br>"
_cMsg += "Duvidas entre em contato com a nossa Central de relacionamento atrav้s do telefone (11)4343-3989 ramal 3083 ou o whatsapp (11)97103-4439.</font>"
_cMsg += "<br>"
_cMsg += "<br>"
_cMsg += "<br>"
_cMsg += "<br>"
_cMsg += "<footer> <b>Caso tenha efetuado o pagamento, desconsiderar este e-mail.</b> </footer>"
_cMsg += "<br>"
_cMsg += "<br>"
_cMsg += "<div><span class=610203920-12022004><FONT face=Verdana color=#000000 size=2>"
_cMsg += "<strong>Atenciosamente, </strong></font></span></div><hr>"
_cMsg += "<strong>KomfortHouse Sofas LTDA</strong></font></span></div><hr>"
_cMsg += "</html>"
