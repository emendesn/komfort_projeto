...
ฑฑบPrograma  ณ SYVR107  บ Autor ณ Marcio Nunes       บ Data ณ  20/01/2020 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ                                   
ฑฑบDescricao ณ Relatorio de PI por แrea                      บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ                
ฑฑบUso       ณ komforthouse                                               บฑฑ
...
Local cTitulo 	:= "Requisi็ใo de PI por มrea"
Local cDescri 	:= "Este programa irแ emitir a Ordem de Produ็ใo por area por PI."

oReport := TReport():New("SYVR108","Requisi็ใo de PI por มrea",,{|oReport| ReportPrint(oReport)},"Requisi็ใo de PI por มrea")  
...
oSection1 := TRSection():New(oReport, "Requisi็ใo de PI por มrea", {"SG1","SB1","SB2"}, {"Por OP"} )
...
While (cAlias)->( !Eof() )      
   	...
   	If (cAreaAnt <> cAreaPos) .Or. cAreaPos == "" // or garente que entra na primeira vez
		...
		If DbSeek( xFilial("SB1")+(cAlias)->COD_PI)    
			...
			EndIf                                                                             
	   		...
	   		//Imprime PI 
	   	   /*	If !(cAlias)->AREA$"MARCENARIA|LAMINACAO"   
		   		oReport:SkipLine()   // salta uma linha
	...
	//imprime cabe็alho de cada PI 
	dbSelectArea("SB1")
	dbSetOrder(1)  
	If DbSeek( xFilial("SB1")+(cAlias)->COD_PI)    
   		cDescPIa := Alltrim(SB1->B1_DESC) 
   	EndIf
   	DbCloseArea("SB1")  
	If cCodAnt <> cCodPos //(cAlias)->AREA$"MARCENARIA|LAMINACAO" .And.    
		oReport:SkipLine()   // salta uma linha      
		oReport:ThinLine() //-- Impressao de Linha Simples                      
		oReport:PrtLeft("PI: "+(cAlias)->COD_PI+" | Descri็ใo: "+cDescPIa+" | UM: PI ")
		oReport:SkipLine()   // salta uma linha 
		oReport:SkipLine()   // salta uma linha       
	EndIf                                         
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณSYPERGUNTAบAutor  ณMicrosiga           บ Data ณ             บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
