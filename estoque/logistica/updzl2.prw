...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZL2" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZL2" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
1																		, ; //X3_TAMANHO
0																		, ; //X3_DECIMAL
'Endereçado'															, ; //X3_TITULO
'Endereçado'															, ; //X3_TITSPA
'Endereçado'															, ; //X3_TITENG
'Endereçado  ?'															, ; //X3_DESCRIC
'Endereçado  ?'															, ; //X3_DESCSPA
'Endereçado  ?'															, ; //X3_DESCENG
''																		, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
