...
é por Pedido de Venda e não por saída de NF.

Incrementada rotina de considerar os Pedidos de Vendas no consumo médio e
criado filtro pra não considerar produtos do tipo "ME" no cálculo do mesmo
pelas NF de saída. - Cristiam Rossi em 24/03/2017
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
*/
...
// Processar Pedidos de Vendas - específico KOMFORTHOUSE - Cristiam Rossi em 24/03/2017
...
cQuery += "AND B1_TIPO = 'ME' "	// considerar tipo ME, específico KOMFORTHOUSE - Cristiam em 24/03/2017
...
cQuery += "AND C6_BLQ = '' "	// não considerar resíduos
...
cQuery += "AND B1_TIPO <> 'ME' "	// não considerar tipo ME, específico KOMFORTHOUSE - Cristiam em 24/03/2017
