...
'Código'																, ; //X3_TITSPA
'Código'																, ; //X3_TITENG
'Código do Termo de Retira'												, ; //X3_DESCRIC
'Código do Termo de Retira'												, ; //X3_DESCSPA
'Código do Termo de Retira'												, ; //X3_DESCENG
'@!'																	, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
'Produto'																, ; //X3_TITSPA
'Produto'																, ; //X3_TITENG
'Código do Produto SB1'													, ; //X3_DESCRIC
'Código do Produto SB1'													, ; //X3_DESCSPA
'Código do Produto SB1'													, ; //X3_DESCENG
'@!'																	, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
'Tipo Ação'																, ; //X3_TITSPA
'Tipo Ação'																, ; //X3_TITENG
'Tipo Ação - chamado SAC'												, ; //X3_DESCRIC
'Tipo Ação - chamado SAC'												, ; //X3_DESCSPA
'Tipo Ação - chamado SAC'												, ; //X3_DESCENG
''																		, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
'Serie da NF de Devolução'												, ; //X3_DESCRIC
'Serie da NF de Devolução'												, ; //X3_DESCSPA
'Serie da NF de Devolução'												, ; //X3_DESCENG
''																		, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
'Data'																	, ; //X3_TITSPA
'Data'																	, ; //X3_TITENG
'Data da Gravação do Termo'												, ; //X3_DESCRIC
'Data da Gravação do Termo'												, ; //X3_DESCSPA
'Data da Gravação do Termo'												, ; //X3_DESCENG
''																		, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
'Tipo de Operação do TR'												, ; //X3_DESCRIC
'Tipo de Operação do TR'												, ; //X3_DESCSPA
'Tipo de Operação do TR'												, ; //X3_DESCENG
''																		, ; //X3_PICTURE
''																		, ; //X3_VALID
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
'€'																		, ; //X3_OBRIGAT
''																		, ; //X3_VLDUSER
'1=Devolução Total;2=Devolução Parcial'									, ; //X3_CBOX
'1=Devolução Total;2=Devolução Parcial'									, ; //X3_CBOXSPA
'1=Devolução Total;2=Devolução Parcial'									, ; //X3_CBOXENG
''																		, ; //X3_PICTVAR
''																		, ; //X3_WHEN
''																		, ; //X3_INIBRW
''																		, ; //X3_GRPSXG
...
30																		, ; //X3_TAMANHO
0																		, ; //X3_DECIMAL
'Autorização'															, ; //X3_TITULO
'Autorização'															, ; //X3_TITSPA
'Autorização'															, ; //X3_TITENG
