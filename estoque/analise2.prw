...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±Ö’’’’’’’’’’ó’’’ ’’’’’’’¿’’’’’’’ó’’’’’’’’’’’’’’’’’’’¿’’’’’’ó’’’’’’’’’’’’’™±±
±±?Programa  =OMSB005  ?Autor  =Rodolfo Vacari       ? Data =  19/08/2005 ?±±
±±√’’’’’’’’’’ˇ’’’’’’’’’’†’’’’’’’ú’’’’’’’’’’’’’’’’’’’’†’’’’’’ú’’’’’’’’’’’’’p±±
±±?Desc.     =                                                            ?±±
±±?          =                                                            ?±±
±±√’’’’’’’’’’ˇ’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’’p±±
...
@ 049,150 SAY "Localiza¡Ño"                             SIZE 040,10 PIXEL OF oDlgMain FONT oBold 
...
@ 022,115 TO 087, 195 PROMPT "Saldo Movimenta¡Ño"        PIXEL OF oFolder:aDialogs[1]
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Documento
@ 001,040 BUTTON "Somente Movimento Com Diferen¡a"     SIZE 100,10 ACTION (Processa({||fSoDocto()})) PIXEL OF oFolder:aDialogs[12]
...
@ 010,005 LISTBOX oDocto Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Status"),;  
	OemToAnsi("Servi¡o"),;
	OemToAnsi("Status Servi¡o"),;
    OemToAnsi("Servi¡o Pendente") SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[12]
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NumSeq
@ 001,040 BUTTON "Somente Movimento Com Diferen¡a"     SIZE 100,10 ACTION (Processa({||fSoNumSeq()})) PIXEL OF oFolder:aDialogs[13]
...
@ 010,005 LISTBOX oNumSeq Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Servi¡o"),;
	OemToAnsi("Status Servi¡o"),;
    OemToAnsi("Servi¡o Pendente") SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[13]
...
IF !Empty(cProduto) .AND. !DBSeek(xFilial("SB1")+cProduto)
   MsgStop("Produto nÑo cadastrado !!!")
   Return (.F.)
Endif

cDescr   := SB1->B1_DESC
cCrlLot  := If(SB1->B1_RASTRO ="L","Lote",If(SB1->B1_RASTRO ="S","Sub-Lote","NÑo"))
cCrlEnd  := If(SB1->B1_LOCALIZ="S","Sim","NÑo")
...
For I:= 1 To Len(aKarLote)   
  Do Case
    ...
    Case aKarLote[I,1] == "SALDO"
       ...
       Endif   
       IF nSaldo <> nSalSB8
          aKarLote[I,10] := "Saldo SB8: "+Trans(nSalSB8,cPict)+"  Diferen¡a: "+Trans(ABS(nSalSB8-nSaldo),cPict)
...
For I:= 1 To Len(aKarEnde)   
  Do Case
    ...
    Case aKarEnde[I,1] == "SALDO"
       ...
       Endif   
       IF nSaldo <> nSalSBF
          aKarEnde[I,9] := "Saldo SBF: "+Trans(nSalSBF,cPict)+"  Diferen¡a: "+Trans(ABS(nSalSBF-nSaldo),cPict)
          cMensSBF      := "SBF diferente do Kardex por Endere¡o"
          cMensagem     := "DIVERGENCIA"
       Endif
  EndCase
Next
...
@ 009,005 SAY "Endere¡o"                                SIZE 040,10 PIXEL OF oDlgSBF FONT oBold  
...
@ 114,005 SAY "Localiza¡Ño"                             SIZE 040,10 PIXEL OF oDlgSDB FONT oBold 
...
@ 009,005 SAY "Endere¡o"                                SIZE 040,10 PIXEL OF oDlgSBK FONT oBold  
...
Do Case
  ...
  Case cOpcao $ "D5+B8_S" // Substrair
     ...
     DBSelectArea("SB8")
     DBSetOrder(3) // B8_FILIAL+B8_PRODUTO+B8_LOCAL+B8_LOTECTL+B8_NUMLOTE+DTOS(B8_DTVALID)
     IF DBSeek(xFilial("SB8")+cProduto+cLocal+cLoteCtl+cNumLote+dDtValid)
        RecLock("SB8",.F.)
        SB8->B8_SALDO  -= nQuant
...
//øÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉü
...
Else	
	...
	//øÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉÉü
	DBSelectArea('SBE')	
	DBSetOrder(1)
...
aadd(aHeader, {"Origem"           , "ORIGEM"  , "@!"              , 03       , 0         ,"U_Valida()"       , ""      , "C"    , ""        ,,})
...
aadd(aHeader, {"TES"              , "TES"     , "@!"              , 03       , 0         ,"U_Valida()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"CF"               , "CF"      , "@!"              , 03       , 0         ,"U_Valida()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Lote"             , "LOTE"    , "@!"              , 10       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"NumLote"          , "NUMLOTE" , "@!"              , 06       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Endere¡o"         , "ENDERECO", "@!"              , 15       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Qtde."            , "QTDE"    , cPict             , 18       , 2         ,"U_Valida()"       , ""      , "N"    , ""        ,,})
aadd(aHeader, {"Qtde.UM2"         , "QTDE2UM" , cPict2UM          , 18       , 2         ,"U_Valida()"       , ""      , "N"    , ""        ,,})
...
IF cCampo $ "M->ORIGEM/M->TES/M->CF"
   MsgStop("Este campo nÑo pode ser alterado.","Aten¡Ño")
   _Return := .F.
